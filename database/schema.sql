...
-- 2. Sellers Table (Seller master data)
...
-- 3. Trust Scores Table (Trust score records with history)
...
-- 4. Seller Metrics Table (Performance metrics)
...
-- 5. Reviews Table (Seller reviews)
...
-- 7. User Watchlist Table (Followed sellers)
