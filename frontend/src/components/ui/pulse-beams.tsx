...
// Reusable Glow Button extracted from the PulseBeams demo style
  ...
  ({ children, className, ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={cn(
          "no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-sm font-semibold leading-6 text-white inline-block",
          className
        )}
        {...props}
      >
        ...
        <div className="relative flex justify-center text-center items-center z-10 rounded-full bg-zinc-950 px-6 py-3 ring-1 ring-white/10">
          <span className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-neutral-200 via-white to-neutral-200 font-semibold">
            {children}
          </span>
        </div>
      </button>
